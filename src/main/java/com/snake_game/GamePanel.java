...
public class GamePanel extends JPanel implements ActionListener {
	...
	public void draw(Graphics g) {
		...
		if(running) {
			...
			g.drawString(  "Score: "  +this.applesEaten ,
					(SCREEN_WIDTH - matrix.stringWidth("Score:"  +this.applesEaten)) /2,
					g.getFont().getSize()
					) ; 
	...
	public void gameOver(Graphics g) {
		...
		g.drawString(  "Game Over " ,
				(SCREEN_WIDTH - matrix.stringWidth("GameOver")) /2,
				SCREEN_HEIGHT/2
				) ; 
		...
		g.drawString(  "Score: "  +this.applesEaten ,
				(SCREEN_WIDTH - matrix2.stringWidth("Score:"  +this.applesEaten)) /2,
				g.getFont().getSize()
				) ; 
